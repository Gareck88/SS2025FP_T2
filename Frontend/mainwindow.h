 ...
 * @author Mike Wild + Yolanda Fiska
 */
#ifndef MAINWINDOW_H
#define MAINWINDOW_H
...
private slots:
    ...
    */
    ...
    /**
     * @brief Stellt Originalzustand des Transkripts aus der Datenbank wiederherstellen.
     */
...
private:
    ...
    /**
     * @brief Lädt die Liste der verfügbaren Meetingsnamen aus der Datenbank in die Seitenleiste.
     */
    void loadMeetings ();
