...
\cleardoublepage\include{Sonstiges/Contents}
...
\include{Kapitel/konzeption_architektur}
\include{Kapitel/implementierung}
\include{Kapitel/audio_windows}
\include{Kapitel/audio_linux}
\include{Kapitel/einleitung_MacOS}
\include{Kapitel/wav_thread}
\include{Kapitel/python}
\include{Kapitel/transkription}
\include{Kapitel/datenbank}
\include{Kapitel/evaluation}
\include{Kapitel/fazit_ausblick}
...
%*************************************************************************
\cleardoublepage\include{Sonstiges/Figures}
%\cleardoublepage\include{Sonstiges/Tables}
\cleardoublepage\include{Sonstiges/Listings}
\cleardoublepage\include{Sonstiges/Acronyms}
\cleardoublepage\include{Sonstiges/Bibliography}
